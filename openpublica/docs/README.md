...
- [x] Gameplay: starter housing demand, sim speed/pause, placement and growth feedback, opening coach (street → lots → plant); the top advisory holds still for up to three months and is a link to the trouble it names
