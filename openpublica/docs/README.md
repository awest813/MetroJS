...
Follow [NEXT_GAPS_PLAN.md](./NEXT_GAPS_PLAN.md) for optional GLB/SSAO and the `App.ts` split. Untextured PBR, sky dome, city-health, mayor Score/advisory, highways, water, zoning plats/downtown, and building degradation are in the HUD.
