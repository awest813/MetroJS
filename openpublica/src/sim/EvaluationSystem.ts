...
export class EvaluationSystem {
  tick(
    ...
    stats.advisory = topAdvisory(stats, census, forecast, budget);
  }
}
...
function topAdvisory(stats: CityStats, census: Census, forecast?: WeatherForecast, budget?: BudgetHints): string {
