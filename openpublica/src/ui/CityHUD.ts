  ...
  constructor(root: HTMLElement) {
    ...
    this._root.innerHTML = `
      <div id="hud-status">
        ...
        <span class="hud-sep">|</span>
        <span class="hud-item" id="hud-walkability">🚶 Walk: 0</span>
        <span class="hud-sep">|</span>
        <span class="hud-item" id="hud-transit">🚃 Transit: 0</span>
      </div>
      <div id="hud-demand">
    ...
    this._walkability   = this._root.querySelector('#hud-walkability')!;
    this._transitAccess = this._root.querySelector('#hud-transit')!;
